...
class Chess:
    ...
    def preparePlayers(self):
        ...
        while True:
            color=input("ingrese el color que desea utilizar(B/W): ")
            if color in ("W","B"):
                botColor="B" if color=="W" else "W"
                break
            
        self.jugadores[0 if color=="W" else 1]=Jugador.Player(color,name)
        self.jugadores[1 if color=="W" else 0]=Jugador.BotPlayer(botColor,color,6)
    ...
    def playRound(self,index):
        ...
        while True:
            ...
            if self.jugadores[index].get_type()=="Human":
            ...
            BOARDPOS=self.tablero.getPositions()
            choice=(self.jugadores[index].make_choice()) if self.jugadores[index].get_type()=="Human" else (self.jugadores[index].make_choice(BOARDPOS))

            origin,destiny,=choice[0],choice[1]
